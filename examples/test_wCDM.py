...
par.DE.w = -0.5
ax.loglog(zs, tools_cosmo.luminosity_distance(zs,par), lw=3, ls='-', label='$\omega={}$'.format(par.DE.w))
par.DE.w = -1.0
ax.loglog(zs, tools_cosmo.luminosity_distance(zs,par), lw=3, ls='--', label='$\omega={}$'.format(par.DE.w))
par.DE.w = -1.5
ax.loglog(zs, tools_cosmo.luminosity_distance(zs,par), lw=3, ls=':', label='$\omega={}$'.format(par.DE.w))
...
par.DE.w = -0.5
ax.semilogx(zs, tools_cosmo.distance_modulus(zs,par), lw=3, ls='-', label='$\omega={}$'.format(par.DE.w))
par.DE.w = -1.0
ax.semilogx(zs, tools_cosmo.distance_modulus(zs,par), lw=3, ls='--', label='$\omega={}$'.format(par.DE.w))
par.DE.w = -1.5
ax.semilogx(zs, tools_cosmo.distance_modulus(zs,par), lw=3, ls=':', label='$\omega={}$'.format(par.DE.w))
