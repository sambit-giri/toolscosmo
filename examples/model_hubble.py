...
fig, ax = plt.subplots(1,1,figsize=(6,5))
ax.set_title('Normalised Hubble', fontsize=15)
ax.loglog(zs, GalaxyTools.Ez_model(par_lcdm)(zs), lw=3, ls='-', label='$\Lambda$CDM'.format(par.DE.w))
par.DE.w = -1.0
...
ax.set_title('Normalised Hubble', fontsize=15)
par.DE.w = -1.0
ax.loglog(zs, GalaxyTools.Ez_model(par)(zs), lw=3, ls='-', label='$\omega={}$,WDM'.format(par.DE.w))
par_growing_nu.DE.Onu  = 0.2
par_growing_nu.DE.Oede = 0.1
ax.loglog(zs, GalaxyTools.Ez_model(par_growing_nu)(zs), lw=3, ls='--', 
...
par.DE.w = -1.0
ax.loglog(zs, GalaxyTools.comoving_distance(zs,par), lw=3, ls='-', label='$\omega={}$,WDM'.format(par.DE.w))
par_growing_nu.DE.Onu  = 0.2
par_growing_nu.DE.Oede = 0.1
ax.loglog(zs, GalaxyTools.comoving_distance(zs,par_growing_nu), lw=3, ls='--', 
            label=r'$\Omega_\nu={}$,$\Omega_e={}$'.format(par_growing_nu.DE.Onu,par_growing_nu.DE.Oede))
par_growing_nu.DE.Onu  = 0.2
par_growing_nu.DE.Oede = 0.2
ax.loglog(zs, GalaxyTools.comoving_distance(zs,par_growing_nu), lw=3, ls=':', 
