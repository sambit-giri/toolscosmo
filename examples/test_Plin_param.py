...
par5.cosmo.plin = toolscosmo.get_Plin(par5, k_per_decade_for_pk=k_per_decade_for_pk)
par6.cosmo.plin = toolscosmo.get_Plin(par6, k_per_decade_for_pk=k_per_decade_for_pk)
