...
ax.loglog(zs, toolscosmo.Ez_model(par)(zs), lw=3, ls='-', label=f'$\omega_0,\omega_a={par.DE.w0},{par.DE.wa}$')
...
par.DE.w0, par.DE.wa = -1.0, 0.0
ax.loglog(zs, toolscosmo.luminosity_distance(zs,par), lw=3, ls='-', label=f'$\omega_0,\omega_a={par.DE.w0},{par.DE.wa}$')
par.DE.w0, par.DE.wa = -1.0, -1.0
ax.loglog(zs, toolscosmo.luminosity_distance(zs,par), lw=3, ls='--', label=f'$\omega_0,\omega_a={par.DE.w0},{par.DE.wa}$')
par.DE.w0, par.DE.wa = -0.5, 0.0
ax.loglog(zs, toolscosmo.luminosity_distance(zs,par), lw=3, ls='-.', label=f'$\omega_0,\omega_a={par.DE.w0},{par.DE.wa}$')
...
par.DE.w0, par.DE.wa = -1.0, 0.0
ax.semilogx(zs, toolscosmo.distance_modulus(zs,par), lw=3, ls='-', label=f'$\omega_0,\omega_a={par.DE.w0},{par.DE.wa}$')
par.DE.w0, par.DE.wa = -1.0, -1.0
ax.semilogx(zs, toolscosmo.distance_modulus(zs,par), lw=3, ls='--', label=f'$\omega_0,\omega_a={par.DE.w0},{par.DE.wa}$')
par.DE.w0, par.DE.wa = -0.5, 0.0
ax.semilogx(zs, toolscosmo.distance_modulus(zs,par), lw=3, ls='-.', label=f'$\omega_0,\omega_a={par.DE.w0},{par.DE.wa}$')
